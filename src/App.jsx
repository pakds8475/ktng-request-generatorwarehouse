...
return ( <main className="page"> <section className="hero"> <div> <p className="eyebrow">KT&G Logistics Tool</p> <h1>Генератор заявок на выдачу и приемку</h1> <p className="heroText">
Заполните данные автомобиля, водителя и груза. Сайт автоматически
соберет DOCX-заявку в формате ваших документов. </p> </div>
